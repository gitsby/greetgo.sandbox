...
//    ClientRecordsViewPdf pdf = new ClientRecordsViewPdf(outputStream);
//    pdf.start();
//    List<ClientRecord> records = getClients(filter);
//    for (ClientRecord record : records) {
//      System.out.println(record.name);
//      pdf.appendRow(record);
//    }
//    System.out.println("finished");
//    pdf.finish(userName, new Date());
  }

}

//class ClientRecordsViewPdf {
//
...
//  }
//
//  public void appendRow(ClientRecord clientRecord) {
//    Stream.of(clientRecord.id + "", clientRecord.surname + "", clientRecord.name + "", clientRecord.patronymic + ""
//      , clientRecord.age + "", clientRecord.charm + "", clientRecord.accBalance + "", clientRecord.minBalance + "", clientRecord.maxBalance + "").forEach(column -> {
