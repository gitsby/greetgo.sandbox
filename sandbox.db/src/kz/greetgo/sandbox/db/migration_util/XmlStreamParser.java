...
import kz.greetgo.sandbox.controller.model.tmpmodels.TmpAddress;
...
public class XmlStreamParser{
    ...
    public  String createBundle(BufferedReader br) throws IOException {
    ...
    public TmpAddress tmpAddressFromString(String innerContent){
    ...
    public TmpClientDetails createTmpClient(String xmlBundle){
